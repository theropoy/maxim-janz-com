		...
		whotext: {
			ger: (
				<>
					...
					<br />
					All die Jahre lang hab ich mich in verschiedenen Tätigkeiten ausprobiert, wie zum Beispiel das
					Erstellen von Neuronalen Netzwerken mit Tensorflow und Python, Game-Entwicklung mit
					unterschiedlichen Game-Engines, App-Entwicklung für die Android Platform und das Entwickeln von
					Webseiten.
				</>
			),
			eng: (
		...
		specext: {
			ger: (
				<>
					...
					Seit 2018 beschäftige ich mich mit der Entwicklung von Videospielen (hautpsächlich für Android) und
					seit 2019 beschäftige ich mich mit Webentwicklung.
				</>
			),
			eng: (
				<>
					...
					<br />
					I've been developing video games since 2018 (mainly for Android) and since 2019 I've been involed in
					web development.
				</>
			),
		},
