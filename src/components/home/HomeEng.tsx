		...
		<div className="home">
			<Helmet>
				...
				<meta
					name="description"
					content={
						"Represent your business with a modern website! I will develop or upgrade your dream website."
					}
				/>
				...
				<meta
					name="keywords"
					content="web developer, webdesign, web design, developer, make website, develope website, wordpress"
				/>
				<html lang="en"></html>
			</Helmet>
			<div id="header-hero">
