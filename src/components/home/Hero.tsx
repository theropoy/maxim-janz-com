...
import helloImg from "../../assets/home/hello.svg"
import avatarImg from "../../assets/home/avatar.svg"
import profileMobileImg from "../../assets/home/profileMobile.png"
import arrowImg from "../../assets/home/down-arrow-white.png"
...
const Hero: React.FC<HeroProps> = ({aboutRef, skillsRef, portfolioRef , contactRef, ger}) => {
    ...
    const text = {
        title: {ger: <>Hi,<br />Ich bin Maxim,<br />ein Entwickler.</>, eng: <>Hi,<br />I'm Maxim,<br />a developer.</>},
    ...
    return (
        <section className={styles.container}>
            ...
            <div className={styles.contactContainer}>
                <button onClick={(e) => executeScroll(contactRef)} className={styles.contact}>{ger? text.contact.ger : text.contact.eng}</button>
            </div>
